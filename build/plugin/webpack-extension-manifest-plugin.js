...
module.exports = class WebpackExtensionManifestPlugin {
  constructor(options) {
    this.options = options;
  }
  webpack4(_compiler) {
    _compiler.hooks.emit.tap('WebpackExtensionManifestPlugin', (compilation) => {
  ...
  webpack5(_compiler) {
    _compiler.hooks.thisCompilation.tap('WebpackExtensionManifestPlugin', (compilation) => {
      if (typeof this.options !== 'object') {
        throw new TypeError('options it should be `object`.');
      }
